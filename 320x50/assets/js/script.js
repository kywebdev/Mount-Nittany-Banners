...
var timeline = (function MasterTimeline() {
    ...
    function createTimeline() {
        ...
        tl.add('white', '+=0.2')
            ...
            .to('#circle-1', 1.2, { left: "61.54px", border: "1px solid white", ease: "cubic-bezier(0.64, 0.04, 0.35, 1)" }, 'white')
            .to('#circle-2', 1.2, { left: "156.54px", border: "1px solid white", ease: "cubic-bezier(0.64, 0.04, 0.35, 1)" }, 'white')
            .to('.logo', 1.03, { left: "171px", top: "10px", ease: "cubic-bezier(0.64, 0.04, 0.35, 1)" }, 'white+=0.17')
        ...
        tl.add('red', '+=0.0')
            ...
            .to('.logo', 1.2, { top: "59px", left: "169px", opacity: 0, ease: "cubic-bezier(0.64, 0.04, 0.35, 1)" }, 'red+=1.0')
            ...
            .to('#cardio', 1.2, { left: "59px", ease: "cubic-bezier(0.64, 0.04, 0.35, 1)" }, 'red+=1.0')
        ...
        tl.add('courageous', '+=2')
            ...
            .to('#logo-color', 1.2, { top: "6px", left: "129px", width: "61px", height: "23px", ease: "cubic-bezier(0.64, 0.04, 0.35, 1)" }, 'courageous')
            .to('#red', 1.2, { top: "69px", ease: "cubic-bezier(0.64, 0.04, 0.35, 1)" }, 'courageous')
            .to('#circle-1', 1.2, { top: "-26px", left: "61.54px", ease: "cubic-bezier(0.64, 0.04, 0.35, 1)" }, 'courageous')
            .to('#circle-2', 1.2, { top: "-26px", left: "156.54px", ease: "cubic-bezier(0.64, 0.04, 0.35, 1)" }, 'courageous')
        ...
        tl.add('logo-color', '+=0.2')
            ...
            .to('.circle', 1.2, { left: "109.04px", ease: "cubic-bezier(0.64, 0.04, 0.35, 1)" }, 'logo-color')
        ...
        tl.add('learn-more', '+=0.2')
            .to('#learn-more', 1.2, { left: "198px", ease: "cubic-bezier(0.64, 0.04, 0.35, 1)" }, 'learn-more')
            .to('#cardio-gray', 1.2, { left: "72px", ease: "cubic-bezier(0.64, 0.04, 0.35, 1)" }, 'learn-more')
            .to('#logo-color', 1.2, { left: "67px", ease: "cubic-bezier(0.64, 0.04, 0.35, 1)" }, 'learn-more')
            .to('.circle', 1.2, { left: "48px", ease: "cubic-bezier(0.64, 0.04, 0.35, 1)" }, 'learn-more');
